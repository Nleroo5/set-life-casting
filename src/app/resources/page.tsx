  ...
  return (
    <div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                {
                  src: "/images/atlanta-background-actor-full-body-front-v3.jpeg",
      ...
      <section className="py-20 bg-linear-to-br from-accent to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="display-md font-bold mb-6 heading-shimmer" style={{ fontFamily: 'var(--font-galindo)', WebkitTextStroke: '3px white' }}>
