        ...
        >
          ...
          <div className="relative bg-white shadow-2xl overflow-hidden rounded-lg">
            ...
            <div className="px-4 sm:px-6 md:px-8 py-4 sm:py-6 relative">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-gray-900 text-center" style={{ fontFamily: 'var(--font-fredoka)' }}>
            ...
            >
              <p className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl leading-relaxed sm:leading-[1.9] text-gray-700 font-normal" style={{ fontFamily: 'var(--font-outfit)' }}>
