...
export default function Newsletter() {
  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 xl:py-24 bg-linear-to-br from-purple-100 via-purple-200 to-purple-300 text-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="display-lg font-bold mb-4 px-2 heading-shimmer" style={{ fontFamily: 'var(--font-galindo)' }}>
