      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link href="/" className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-lg md:text-xl lg:text-xl xl:text-2xl font-bold" style={{ fontFamily: 'var(--font-galindo)' }}>Set Life Casting</span>
            </Link>
            <p className="text-white/90 text-base md:text-lg lg:text-lg xl:text-xl">
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-bold mb-4 text-white text-base md:text-lg lg:text-lg xl:text-xl">Company</h3>
            <ul className="space-y-2">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-white/80 hover:text-accent transition-colors duration-200 text-base md:text-lg lg:text-lg xl:text-xl"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Resources Links */}
          <div>
            <h3 className="font-bold mb-4 text-white text-base md:text-lg lg:text-lg xl:text-xl">Resources</h3>
            <ul className="space-y-2">
          ...
          {/* Contact & Social */}
          <div>
            <h3 className="font-bold mb-4 text-white text-base md:text-lg lg:text-lg xl:text-xl">Connect</h3>
            <div className="space-y-3 mb-6">
              <a
                href="mailto:SetLifeCasting@gmail.com"
                className="text-white/80 hover:text-accent transition-colors duration-200 text-base md:text-lg lg:text-lg xl:text-xl block"
              >
        ...
        <div className="mt-12 pt-8 border-t border-white/10 shadow-[0_-1px_10px_rgba(168,85,247,0.1)]">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col sm:flex-row items-center gap-4 text-base md:text-lg lg:text-lg xl:text-xl">
