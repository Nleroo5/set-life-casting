      ...
      */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-8">
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-bold mb-4 text-white text-base md:text-base">Company</h3>
            <ul className="space-y-2">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-white/80 hover:text-accent transition-colors duration-200 text-base md:text-base"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Resources Links */}
          <div>
            <h3 className="font-bold mb-4 text-white text-base md:text-base">Resources</h3>
            <ul className="space-y-2">
          ...
          {/* Contact & Social */}
          <div>
            <h3 className="font-bold mb-4 text-white text-base md:text-base">Connect</h3>
            <div className="space-y-3 mb-6">
              <a
                href="mailto:SetLifeCasting@gmail.com"
                className="text-white/80 hover:text-accent transition-colors duration-200 text-base md:text-base block"
              >
